...
import storm.starter.spout.TestSpout_StepIncrease_WithTimer;

public class DiamondTopology_5_diurnal_lexu {
	public static void main(String[] args) throws Exception {
		...
		builder.setSpout("spout_head", new TestSpout_StepIncrease_WithTimer(), paralellism*2).setNumTasks(40);
