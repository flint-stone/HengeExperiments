...
import storm.starter.spout.TestSpout_WithTimer;

public class DiamondTopology_6_diurnal_lexu {
	public static void main(String[] args) throws Exception {
		...
		builder.setSpout("spout_head", new TestSpout_WithTimer(), paralellism*2).setNumTasks(2);
