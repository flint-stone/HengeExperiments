...
import storm.starter.bolt.NoopBolt;
import storm.starter.spout.TestSpout;

public class DiamondTopology_NOOP_lexu {
	public static void main(String[] args) throws Exception {
		...
		builder.setBolt("bolt_1", new NoopBolt(), paralellism).setNumTasks(paralellism ).setNumTasks(5).shuffleGrouping("spout_head");
		builder.setBolt("bolt_2", new NoopBolt(), paralellism).setNumTasks(paralellism ).setNumTasks(5).shuffleGrouping("spout_head");
		builder.setBolt("bolt_3", new NoopBolt(), paralellism).setNumTasks(paralellism ).setNumTasks(5).shuffleGrouping("spout_head");
		builder.setBolt("bolt_4", new NoopBolt(), paralellism).setNumTasks(paralellism ).setNumTasks(5).shuffleGrouping("spout_head");
