...
import storm.starter.spout.RandomLogSpout_EPA;
import storm.starter.spout.RandomLogSpout_FB2;

public class PageLoadTopology_lexu_EPA {
	public static void main(String[] args) throws Exception {
		...
		builder.setSpout("spout_head", new RandomLogSpout_EPA(), paralellism).setNumTasks(paralellism);
