...
public class StarTopology_8_lexu {
	public static void main(String[] args) throws Exception {
		...
		BoltDeclarer center = builder.setBolt("center", new TestBolt(),
				paralellism).setNumTasks(40);

		for (int i = 0; i < numSpout; i++) {
			builder.setSpout("spout_" + i, new TestSpout(), paralellism).setNumTasks(40);
			center.shuffleGrouping("spout_" + i);
		}

		for (int i = 0; i < numBolt; i++) {
			builder.setBolt("bolt_output_" + i, new OutBolt("sink"), paralellism).setNumTasks(40)
